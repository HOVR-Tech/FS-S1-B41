...
const createProjectItem = (project) => {
  const { id, projectName, startDate, endDate, projectDesc, useNodeJS, useReactJS, useNextJS, useTypeScript, uploadImage } = project;
...
const getCreationDate = (startDate) => {
  ...
  const arrayMonth = ['January', 'February', 'March', 'April', 'June', 'July', 'August', 'September', 'October', 'November', 'December'];
  ...
  createdMonth = arrayMonth[createdMonth - 1];
